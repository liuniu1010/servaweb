...
import org.neo.servaaiagent.impl.ChatWithSpeechToTextExpertForUIImpl;

@Path("/aichatwithspeechtotextexpert")
public class AIChatWithSpeechToTextExpert extends AbsAIChat {
    ...
    protected ChatForUIIFC getChatForUIInstance() {
        return ChatWithSpeechToTextExpertForUIImpl.getInstance(getOnlineFileAbsolutePath(), getRelevantVisitPath());
    }

    @Override
    protected String getHook() {
        return "aichatwithspeechtotextexpert";
    }
