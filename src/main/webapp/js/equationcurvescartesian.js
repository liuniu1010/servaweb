// Equation Curves Cartesian page-specific logic
...
function newChat() {
    var newChatUrl = "api/aiequationcurvescartesian/newchat";
...
function undo() {
    var undoUrl = "api/aiequationcurvescartesian/undo";
    var userInput = "";
    disableSend();
    $.ajax({
        url: undoUrl,
...
function streamsend(base64String) {
    var streamsendUrl = "api/aiequationcurvescartesian/streamsend";
    var userInput = document.getElementById("UserInput").value;
    var theFunction = "equationcurvescartesian";
    disableSend();
...
function streamrefresh() {
    var streamrefreshUrl = "api/aiequationcurvescartesian/streamrefresh";
    var userInput = "";
    disableSend();
    $.ajax({
...
function downloadIframeContent() {
    ...
    a.href = url;
    a.download = "equationcurvescartesian.html";
